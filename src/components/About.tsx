    ...
    <section id="about" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          {/* About Me Content */}
          <Card
            className="cyber-card group h-full flex items-center justify-center p-8 border-0"
            data-index={0}
            ...
            <CardContent className="p-0">
              <div className="space-y-6 cyber-text-body">
                <p className="text-lg leading-relaxed text-gray-300">
                  I'm currently pursuing my <span className="font-medium text-pink-400">B.Tech in Computer Science Engineering</span> with a specialization in <span className="font-medium text-cyan-400">AI & ML</span>, maintaining an impressive <span className="font-medium text-purple-400">8.07 CGPA</span>. My journey combines technical expertise with innovative problem-solving.
                </p>
                <p className="text-lg leading-relaxed text-gray-300">
                  Passionate about creating impactful digital solutions, I specialize in <span className="font-medium text-pink-400">Full-Stack Development</span>, <span className="font-medium text-cyan-400">Machine Learning</span>, and <span className="font-medium text-purple-400">Cloud Computing</span>. My approach bridges cutting-edge technology with practical applications.
                </p>
                <p className="text-lg leading-relaxed text-gray-300">
                  Recognized as a <span className="font-medium cyber-text">Tech Innovator</span> and <span className="font-medium cyber-text">Problem Solver</span>, I combine analytical thinking with creative solutions to build applications that make a real difference in people's lives.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-2 gap-6">
            {stats.map((stat, index) => (
              <Card
                key={index}
                className="cyber-card group h-40 flex items-center justify-center border-0"
                data-index={index + 1}
                ref={(el) => el && observerRef.current?.observe(el)}
              >
                <CardContent className="p-6 text-center">
                  <div className="mb-4">
                    <div className={`w-12 h-12 rounded-full bg-gradient-to-r ${stat.gradient} flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-500 cyber-glow`}>
